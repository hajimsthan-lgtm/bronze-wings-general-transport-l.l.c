...
const VARIANTS = {
  green:  { gradient: 'linear-gradient(135deg, rgba(74,222,128,0.25) 0%, rgba(34,197,94,0.10) 50%, hsl(var(--card)) 100%)', rgb: '74,222,128', glow: '#22c55e' },
  ...
  blue:   { gradient: 'linear-gradient(135deg, rgba(59,130,246,0.22) 0%, rgba(37,99,235,0.08) 50%, hsl(var(--card)) 100%)', rgb: '59,130,246', glow: '#3b82f6' },
