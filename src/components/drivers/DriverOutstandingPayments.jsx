...
export default function DriverOutstandingPayments({ salaries = [], onMarkPaid, busyId, collapsible = false, defaultOpen = true }) {
  ...
  return (
    <div className="glass-card p-4 mb-4" style={{ borderLeft: '3px solid rgba(245,158,11,0.55)' }}>
      ...
      <div className="overflow-hidden transition-all duration-700 ease-in-out" style={{ maxHeight: open ? '2000px' : '0', opacity: open ? 1 : 0 }}>
