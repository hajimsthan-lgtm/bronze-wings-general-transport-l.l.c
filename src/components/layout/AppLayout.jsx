...
export default function AppLayout() {
  ...
  return (
    <div className="min-h-[100dvh] md:h-[100dvh] flex flex-col md:flex-row relative md:overflow-hidden" style={{ background: 'var(--app-bg)' }}>
      {/* ═══════════════════════════════════════════════════════
      ...
      {/* ═══════════════════════════════════════════════════════
          LEFT NAVIGATION RAIL — in-flow so it sits flush against
          the main panel and pushes (shrinks) content on expand.
          ═══════════════════════════════════════════════════════ */}
      <ContentSidebar />

      {/* ═══════════════════════════════════════════════════════
          CONTENT COLUMN — flex-1; shrinks automatically when the
          sidebar expands, grows back when it collapses.
          ═══════════════════════════════════════════════════════ */}
      <div className="flex-1 flex flex-col min-w-0 relative z-10">
        ...
        {/* ═══════════════════════════════════════════════════════
            MAIN CONTENT — panel flush against the sidebar; left padding
            removed on desktop so there is no gap between rail and panel.
            ═══════════════════════════════════════════════════════ */}
        <main className="flex-1 min-h-0 flex flex-col px-3 md:pl-0 md:pr-5 lg:pr-7 max-w-[1440px] mx-auto md:ml-0 w-full relative z-10 pt-3 md:pt-0">
          <div
            ...
            <div className="relative z-10 md:flex-1 md:min-h-0 md:overflow-y-auto thin-scroll">
              <div className="p-4 pb-28 md:p-6 md:pt-32 md:pb-24">
                <Outlet />
              </div>
            </div>
          </div>
