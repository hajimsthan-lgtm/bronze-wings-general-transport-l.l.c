...
export default function ReportSectionCard({ color, title, index = 0, children, className = '', action }) {
  ...
  return (
    <div
      className={`relative overflow-hidden p-6 animate-fade-in-up hover:-translate-y-0.5 transition-all duration-400 bg-card rounded-3xl ${className}`}
      style={{
        animationDelay: `${index * 0.1}s`,
        border: `1px solid ${rgba(0.22)}`,
        boxShadow: `0 4px 16px rgba(0,0,0,0.06), inset 0 1px 0 rgba(255,255,255,0.8), 0 0 28px ${rgba(0.06)}`,
      }}
    >
