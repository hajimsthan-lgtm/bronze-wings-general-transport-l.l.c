...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 active:scale-[0.97] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-[linear-gradient(135deg,#2D6A4F,#52796F)] text-white shadow-[0_4px_16px_rgba(45,106,79,0.3),inset_0_1px_0_rgba(255,255,255,0.2)] hover:brightness-110 hover:scale-[1.02] hover:shadow-[0_6px_24px_rgba(45,106,79,0.4),inset_0_1px_0_rgba(255,255,255,0.3)] transition-all duration-300",
        destructive:
