...
export default function AgreementPreview({ form, settings }) {
  const s = settings || {};
        ...
        <div style={{ border: `0.5px solid ${LIGHT_GRAY}`, flex: 1, padding: '4px', display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ border: `0.5px solid ${LIGHT_GRAY}`, display: 'flex', minHeight: '60px' }}>
            <div style={{ flex: 1, padding: '6px 8px', borderRight: `0.5px solid ${LIGHT_GRAY}` }}>
              <div style={{ fontSize: '9px', fontWeight: 'bold', color: MAROON, textTransform: 'uppercase', borderBottom: `1px solid ${MAROON}`, display: 'inline-block', paddingBottom: '1px', marginBottom: '4px' }}>SECOND PARTY</div>
            ...
            <div style={{ width: '180px', padding: '6px 8px', fontSize: '9px', color: BLACK, lineHeight: 1.8 }}>
              <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '2px' }}><span style={{ fontWeight: 'normal' }}>AGREEMENT #:</span><span>{esc(form.agreement_number || '—')}</span></div>
              <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '2px' }}><span style={{ fontWeight: 'normal' }}>START DATE:</span><span>{fmtDate(form.start_date)}</span></div>
              <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '2px' }}><span style={{ fontWeight: 'normal' }}>END DATE:</span><span>{fmtDate(form.end_date)}</span></div>
              <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '2px' }}><span style={{ fontWeight: 'normal' }}>TYPE:</span><span style={{ textTransform: 'capitalize' }}>{esc(form.agreement_type || 'service')}</span></div>
            </div>
          </div>

          {/* Title */}
          <div style={{ padding: '8px 4px 4px' }}>
            <div style={{ fontSize: '12px', fontWeight: 'bold', color: MAROON, lineHeight: 1.3 }}>
              {esc(form.title || 'Service Agreement')}
            </div>
          </div>
          ...
          <div style={{ marginTop: '6px' }}>
            <div style={{ fontSize: '9px', fontWeight: 'bold', color: MAROON, textTransform: 'uppercase', borderBottom: `1px solid ${MAROON}`, display: 'inline-block', paddingBottom: '1px', marginBottom: '4px' }}>FIRST PARTY</div>
            <div style={{ fontSize: '9px', color: BLACK, lineHeight: 1.5 }}>
          ...
          {form.content && (
            <div style={{ marginTop: '8px' }}>
              <div style={{ fontSize: '9px', fontWeight: 'bold', color: MAROON, textTransform: 'uppercase', borderBottom: `1px solid ${MAROON}`, display: 'inline-block', paddingBottom: '1px', marginBottom: '4px' }}>TERMS OF AGREEMENT</div>
              <div style={{ fontSize: '9px', color: BLACK, lineHeight: 1.5, whiteSpace: 'pre-wrap', wordBreak: 'break-word' }}>
                {esc(form.content)}
              </div>
            </div>
          )}
          ...
          {form.terms_conditions && (
            <div style={{ marginTop: '8px' }}>
              <div style={{ fontSize: '9px', fontWeight: 'bold', color: MAROON, textTransform: 'uppercase', borderBottom: `1px solid ${MAROON}`, display: 'inline-block', paddingBottom: '1px', marginBottom: '4px' }}>TERMS &amp; CONDITIONS</div>
              <div style={{ fontSize: '9px', color: BLACK, lineHeight: 1.5, whiteSpace: 'pre-wrap', wordBreak: 'break-word' }}>
                {esc(form.terms_conditions)}
              </div>
            </div>
          )}
          ...
          <div style={{ display: 'flex', marginTop: '12px', gap: '8px' }}>
            <div style={{ flex: 1, textAlign: 'center' }}>
              <div style={{ fontSize: '8px', fontWeight: 'bold', color: '#333', textTransform: 'uppercase', letterSpacing: '0.5px', marginBottom: '20px' }}>FIRST PARTY</div>
            ...
            <div style={{ flex: 1, textAlign: 'center' }}>
              <div style={{ fontSize: '8px', fontWeight: 'bold', color: '#333', textTransform: 'uppercase', letterSpacing: '0.5px', marginBottom: '20px' }}>SECOND PARTY</div>
              <div style={{ borderTop: '0.5px solid #333', marginBottom: '2px', width: '80%', margin: '0 auto' }} />
