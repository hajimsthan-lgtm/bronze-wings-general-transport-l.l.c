  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center gap-2 px-6 py-7 text-center">
        ...
        <p className="text-sm font-semibold text-foreground">Scan UAE Vehicle License</p>
        <p className="text-xs text-muted-foreground max-w-[260px] leading-relaxed">
          Drag & drop a PDF or image, or browse. AI extracts all fields — review before saving.
        </p>
        <button
          type="button"
