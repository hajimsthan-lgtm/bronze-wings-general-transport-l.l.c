...
export default function DriverCard({ d, onOpen, onEdit, onDelete }) {
  ...
  return (
    ...
    >
      ...
      <div className="relative mt-3 h-28 rounded-xl overflow-hidden border border-border flex items-center justify-center" style={{ background: `linear-gradient(135deg, ${ACCENT}26 0%, hsl(var(--muted)) 70%)` }}>
        ...
        <div className="relative w-16 h-16 rounded-full overflow-hidden flex items-center justify-center text-xl font-bold" style={{ background: `linear-gradient(135deg, ${ACCENT}50, ${ACCENT}18)`, border: `1px solid ${ACCENT}55`, boxShadow: `0 0 24px -6px ${ACCENT}, inset 0 1px 0 rgba(255,255,255,0.4)`, color: 'hsl(var(--foreground))' }}>
