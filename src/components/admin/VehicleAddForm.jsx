  ...
  return (
    <div className="space-y-4">
      ...
      <Section icon={FileText} title="License Details" accent="#0ea5e9">
        ...
        <Field label="Expiry Date"><DatePicker value={form.expDate} onChange={(v) => update('expDate', v)} className="bg-background border-border" /></Field>
        <Field label="Registration Date"><DatePicker value={form.regDate} onChange={(v) => update('regDate', v)} className="bg-background border-border" /></Field>
      ...
      <Section icon={ShieldCheck} title="Insurance" accent="#22c55e">
        ...
        <Field label="Insurance Expiry"><DatePicker value={form.insExpDate} onChange={(v) => update('insExpDate', v)} className="bg-background border-border" /></Field>
