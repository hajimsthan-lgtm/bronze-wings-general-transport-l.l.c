...
const flagInfo = (inv, clientAdvance) => {
  ...
  return { rank: 3, key: 'open', label: isSent ? 'Sent' : 'Unpaid', color: isSent ? '#6EE7B7' : '#4ADE80', bg: isSent ? 'rgba(129,140,248,0.14)' : 'rgba(110,231,183,0.12)', border: isSent ? 'rgba(129,140,248,0.4)' : 'rgba(110,231,183,0.35)', Icon: isSent ? MailCheck : Calendar, sent: isSent };
};
