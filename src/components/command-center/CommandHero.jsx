  ...
  return (
    <div className="relative overflow-hidden cmd-card animate-enter-up" style={{ animationDelay: '0.05s' }}>
      <div className="absolute inset-0 pointer-events-none" style={{
        background: `radial-gradient(ellipse 60% 80% at 20% 0%, rgba(var(--brand-bronze-rgb),0.06), transparent 70%),
                     radial-gradient(ellipse 50% 70% at 80% 100%, rgba(var(--brand-blue-rgb),0.05), transparent 70%)`
      }} />
          ...
          {actions.map((a) => {
            ...
            return (
              <button
                ...
                className="group flex items-center gap-2.5 px-4 py-2.5 rounded-2xl bg-foreground/[0.04] border border-border/40 hover:border-[rgba(var(--brand-blue-rgb),0.3)] hover:bg-foreground/[0.06] transition-all duration-200 hover:-translate-y-0.5"
              >
