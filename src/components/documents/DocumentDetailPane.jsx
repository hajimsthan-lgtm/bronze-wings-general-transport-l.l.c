      ...
      <div className="px-4 sm:px-5 py-3 sm:py-4 border-b border-border/40">
        <div className="flex items-start justify-between gap-2 sm:gap-3">
          <div className="flex items-center gap-2.5 sm:gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap">
                <h3 className="text-sm sm:text-base font-bold text-foreground font-mono">{item[numberField] || '—'}</h3>
                <span className={`px-1.5 sm:px-2 py-0.5 rounded text-[10px] font-semibold border flex-shrink-0 ${cfg.pill}`}>
                  {cfg.label}
                </span>
                {signatureFlag && (
                  <span
                    className={`inline-flex items-center gap-0.5 px-1.5 sm:px-2 py-0.5 rounded text-[10px] font-semibold border flex-shrink-0 ${signatureFlag.pill}`}
          ...
          <div className="flex items-center gap-1 sm:gap-1.5 flex-shrink-0">
            ...
            <button onClick={() => onEdit(item)} className="w-8 h-8 rounded-lg flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-muted/50 transition-colors flex-shrink-0" title="Edit">
              <Pencil className="w-3.5 h-3.5" />
            </button>
            <button onClick={() => onDelete(item)} className="w-8 h-8 rounded-lg flex items-center justify-center text-muted-foreground hover:text-red-500 hover:bg-red-500/10 transition-colors flex-shrink-0" title="Delete">
