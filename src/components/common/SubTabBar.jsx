      ...
      {options.map((o) => {
        ...
        return (
          <button
            ...
            className={`inline-flex items-center gap-1.5 h-8 px-3 rounded-md text-xs font-semibold uppercase tracking-wider transition-colors bg-primary/15 text-primary ${active ? "" : ''} ${compact ? '!px-2.5 !py-1.5 !text-[10px]' : ''}`}
            title={o.label}>
